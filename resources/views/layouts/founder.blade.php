...
<head>
    ...
    <title>Founder Dashboard - StartupPlatform</title>
...
<body>
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <ul class="sidebar-menu">
            <li>
                <a href="{{ route('founder.panel') }}" class="{{ request()->routeIs('founder.panel') ? 'active' : '' }}">
                    <i data-lucide="trending-up" style="margin-right: 12px; width: 18px;"></i>
                    Dashboard
                </a>
            </li>
            <li>
                <a href="{{ route('startups.index') }}" class="{{ request()->routeIs('startups.index') ? 'active' : '' }}">
                    <i data-lucide="landmark" style="margin-right: 12px; width: 18px;"></i>
                    My Startups
                </a>
            </li>
            <li>
                <a href="{{ route('startups.create') }}" class="{{ request()->routeIs('startups.create') ? 'active' : '' }}">
                    <i data-lucide="rocket" style="margin-right: 12px; width: 18px;"></i>
                    Launch Startup
                </a>
            </li>
            <li>
